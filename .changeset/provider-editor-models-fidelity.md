...
that exists only in the fetched upstream catalog is not on the whitelist, so
removing it is a no-op and leaves its aliases alone. OAuth providers get the same

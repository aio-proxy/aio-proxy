...
Also in the editor: provider sections render as cards, the models list keeps its helper text, and the provider ID field says up front that the ID is fixed once saved.

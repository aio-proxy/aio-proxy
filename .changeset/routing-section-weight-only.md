...
would otherwise have disappeared from the page. Creating a provider now writes an explicit weight of
0, so the badge, the slider position and the stored value agree instead of reading "no weight set"

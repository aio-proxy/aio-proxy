...
type AioProxyLogoProps = Omit<ComponentProps<'svg'>, 'viewBox'>;

export function AioProxyLogo({ className, children, ...props }: AioProxyLogoProps) {
  return (
    <svg
    ...
    >
      ...
      <text x="720" y="365" fontSize="360" className="font-heading font-semibold">
        Proxy
      </text>
    </svg>
  );

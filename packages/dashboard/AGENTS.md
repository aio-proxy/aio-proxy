...
- Add missing shadcn components from `packages/ui` with `bun x --bun shadcn@4.13.0 add <component> --overwrite`; `packages/ui/components.json` is the source of truth.

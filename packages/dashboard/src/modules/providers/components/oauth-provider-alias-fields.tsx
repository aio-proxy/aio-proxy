...
export const OAuthProviderAliasFields: React.FC<OAuthProviderAliasFieldsProps> = ({ form, open, onOpenChange }) => (
    ...
    {(models) => (
      <form.Field name="alias">
        {(field) => {
          ...
          const update = (next: ProviderAlias) => field.handleChange(serializeAlias(next, ProviderFormMode.Edit));
